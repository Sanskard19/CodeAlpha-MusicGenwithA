...
## Submission Advice
For GitHub and resume value, keep this repo modular and include:
- `models/loss_curve.png`
- one generated `.mid` file in `outputs/`
- screenshots of the Streamlit app
- a short explanation of dataset and architecture in the README
